module Populator
  module Items
    ...
    def create_muffins_and_prices
      ...
      bl3 = FactoryBot.create(:item_price, item: blueberry, price: 8.95, start_date: 2.weeks.ago.to_date)  
      ...
      cz3 = FactoryBot.create(:item_price, item: chocolate_zuke, price: 8.95, start_date: 2.weeks.ago.to_date)
